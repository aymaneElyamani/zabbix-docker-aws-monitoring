...
![Figure 1 : Création du VPC](images/1-cree-un-vpc.png)

*Figure 1 : Création du VPC*

![Figure 2 : Création du sous-réseau](images/2-cree-un-sous-reseau.png)

*Figure 2 : Création du sous-réseau*

![Figure 3 : Organisation des sous-réseaux (public/privé)](images/3-subnet-prive-et-public.png)
...
![Figure 4 : Création d’un groupe de sécurité](images/4-cree-un-groupe-de-securite.png)

*Figure 4 : Création d’un groupe de sécurité*

![Figure 5 : Règles entrantes (ports requis)](images/5-regles-entrantes.png)

*Figure 5 : Règles entrantes (ports requis)*

![Figure 6 : Règles sortantes](images/6-regles-sortantes.png)

*Figure 6 : Règles sortantes*

![Figure 7 : Groupe de sécurité créé avec succès](images/7-creation-de-groupe-succes.png)
...
![Figure 8 : Lancement de l’instance EC2 (serveur Zabbix)](images/8-lancer-instance-zabbix.png)

*Figure 8 : Lancement de l’instance EC2 (serveur Zabbix)*

![Figure 9 : Création de la clé de connexion (Key Pair)](images/9-cree-cle-paire-zabbix.png)

*Figure 9 : Création de la clé de connexion (Key Pair)*

![Figure 10 : Configuration des paramètres réseau](images/10-configurer-parametre-reseau.png)

*Figure 10 : Configuration des paramètres réseau*

![Figure 11 : Instance créée avec succès](images/11-creation-dinstance-succes.png)

*Figure 11 : Instance créée avec succès*

![Figure 12 : Connexion SSH réussie au serveur](images/12-connection-ssh-succes.png)
...
![Figure 13 : Installation de Docker et Docker Compose](images/13-instalation-docker-et-dockercompose.png)
...
![Figure 14 : Vérification des conteneurs Docker](images/14-verification-des-container.png)
...
![Figure 15 : Lancement des services Zabbix via Docker](images/15-lancement-de-zabbix.png)

*Figure 15 : Lancement des services Zabbix via Docker*

![Figure 16 : Accès au tableau de bord Zabbix](images/16-dashboard-zabbix.png)

*Figure 16 : Accès au tableau de bord Zabbix*

![Figure 17 : Vue « Hosts » (supervision des hôtes)](images/17-monitoring-hosts.png)
...
![Figure 18 : Lancement de l’instance EC2 (client Linux)](images/18-lancer-instance-client-linux.png)

*Figure 18 : Lancement de l’instance EC2 (client Linux)*

![Figure 19 : Configuration « server / client / agent »](images/19-configuration-sever-client-agent.png)

*Figure 19 : Configuration « server / client / agent »*

![Figure 20 : Activation du service agent côté client Linux](images/20-enable-server-linux-client-agent.png)

*Figure 20 : Activation du service agent côté client Linux*

![Figure 21 : Modification/validation des paramètres de l’hôte Linux](images/21-modifier-host-client-linux.png)
...
![Figure 22 : Lancement de l’instance EC2 (client Windows)](images/22-lancer-instance-client-windows.png)

*Figure 22 : Lancement de l’instance EC2 (client Windows)*

![Figure 23 : Affichage et accès au client Windows](images/23-affichage-de-serveur-client-windows.png)

*Figure 23 : Affichage et accès au client Windows*

![Figure 24 : Installation de l’agent Zabbix sur Windows](images/24-instalation-zabbix-sur-windows.png)
...
![Figure 25 : Paramétrage de l’hôte Windows dans Zabbix](images/25-modifier-host-client-windows.png)
...
![Figure 26 : Ajout des hôtes réussi](images/26-hosts-added-success.png)

*Figure 26 : Ajout des hôtes réussi*

![Figure 27 : Liste des hôtes (statut de connexion)](images/27-hosts-lists.png)
...
![Figure 28 : « Latest data » pour le client Linux](images/28-latest-data-pour-linux.png)

*Figure 28 : « Latest data » pour le client Linux*

![Figure 29 : « Latest data » pour le client Windows](images/29-latest-data-pour-windows.png)

*Figure 29 : « Latest data » pour le client Windows*

![Figure 30 : Graphiques de supervision (CPU/RAM, etc.)](images/30-graphs.png)
